 ...
 * @author previotto
 */
public class CodigoFacturacionDAOImplementacionTest {
    
    public CodigoFacturacionDAOImplementacionTest() {
    }
    ...
    public void testObtenerLista() throws Exception {
        ...
        CodigoFacturacion objetoParametro = null;
        CodigoFacturacionDAOImplementacion instance = new CodigoFacturacionDAOImplementacion();
        List<CodigoFacturacion> expResult = null;
        List<CodigoFacturacion> result = instance.obtenerLista(objetoParametro);
    ...
    public void testObtener() throws Exception {
        ...
        CodigoFacturacion objetoParametro = null;
        CodigoFacturacionDAOImplementacion instance = new CodigoFacturacionDAOImplementacion();
        CodigoFacturacion expResult = null;
        CodigoFacturacion result = instance.obtener(objetoParametro);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
