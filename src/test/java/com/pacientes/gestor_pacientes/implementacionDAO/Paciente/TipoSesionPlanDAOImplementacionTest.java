 ...
 * @author previotto
 */
public class TipoSesionPlanDAOImplementacionTest {
    
    public TipoSesionPlanDAOImplementacionTest() {
    }
  ...
  /*
    ...
    public void testObtener() throws Exception {
        ...
        TipoSesion objetoParametro = null;
        TipoSesionPlanDAOImplementacion instance = new TipoSesionPlanDAOImplementacion();
        TipoSesion expResult = null;
        TipoSesion result = instance.obtener(objetoParametro);
    ...
    public void testObtenerLista() throws Exception {
        ...
        TipoSesion objetoParametro = null;
        TipoSesionPlanDAOImplementacion instance = new TipoSesionPlanDAOImplementacion();
        List<TipoSesion> expResult = null;
        List<TipoSesion> result = instance.obtenerLista(objetoParametro);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }*/
