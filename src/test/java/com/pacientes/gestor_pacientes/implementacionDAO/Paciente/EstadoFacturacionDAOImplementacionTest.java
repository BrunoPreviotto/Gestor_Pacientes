 ...
 * @author previotto
 */
public class EstadoFacturacionDAOImplementacionTest {
    
    public EstadoFacturacionDAOImplementacionTest() {
    }
    ...
    public void testObtenerLista() throws Exception {
        ...
        EstadoFacturacion objetoParametro = null;
        EstadoFacturacionDAOImplementacion instance = new EstadoFacturacionDAOImplementacion();
        List<EstadoFacturacion> expResult = null;
        List<EstadoFacturacion> result = instance.obtenerLista(objetoParametro);
    ...
    public void testObtener() throws Exception {
        ...
        EstadoFacturacion objetoParametro = null;
        EstadoFacturacionDAOImplementacion instance = new EstadoFacturacionDAOImplementacion();
        EstadoFacturacion expResult = null;
        EstadoFacturacion result = instance.obtener(objetoParametro);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
