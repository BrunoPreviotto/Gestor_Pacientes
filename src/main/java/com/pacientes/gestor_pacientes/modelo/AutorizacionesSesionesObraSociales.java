...
public class AutorizacionesSesionesObraSociales {
    private int id;
    private Long numeroAutorizacion; //LONG
    ...
    public AutorizacionesSesionesObraSociales(Long numeroAutorizacion, LocalDate asociacion) {
        this.numeroAutorizacion = numeroAutorizacion;
        this.asociacion = asociacion;
    }

    public AutorizacionesSesionesObraSociales(Long numeroAutorizacion, LocalDate asociacion, int idSesion, int idPaciente) {
        this.numeroAutorizacion = numeroAutorizacion;
        this.asociacion = asociacion;
    ...
    public AutorizacionesSesionesObraSociales(int id, Long numeroAutorizacion, String observacion, LocalDate asociacion, Double copago, CodigoFacturacion codigoFacturacion, int idSesion, int idPaciente) {
        this.id = id;
        this.numeroAutorizacion = numeroAutorizacion;
        this.observacion = observacion;
        this.asociacion = asociacion;
